...
##############    
    ...
    if smex:
        ...
        try:
            ...
            await str1(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str1(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if smexx:
        ...
        try:
            ...
            await str2.start()
            await str2(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str2(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if smexxx:
        ...
        try:
            ...
            await  str3.start()
            await str3(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str3(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if smexxxx:
        ...
        try:
            ...
            await str4.start()
            await str4(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str4(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if smexxxxx:
        ...
        try:
            ...
            await str5.start()
            await str5(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str5(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if sixth:
        ...
        try:
            ...
            await str6.start()
            await str6(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str6(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if seven:
        ...
        try:
            ...
            await str7.start()
            await str7(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str7(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if eight:
        ...
        try:
            ...
            await str8.start()
            await str8(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str8(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if ninth:
        ...
        try:
            ...
            await str10.start()
            await str10(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str10(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if tenth:
        ...
        try:
            ...
            await str9.start()
            await str9(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str9(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if eleventh:
        ...
        try:
            ...
            await str11(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str11(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            str11 = "eleventh"
...
##############            
    ...
    if twelve:
        ...
        try:
            ...
            await str12.start()
            await str12(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str12(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if thirteen:
        ...
        try:
            ...
            await  str13.start()
            await str13(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str13(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if fourteen:
        ...
        try:
            ...
            await str14.start()
            await str14(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str14(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if fifteen:
        ...
        try:
            ...
            await str15.start()
            await str15(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str15(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if sixteen:
        ...
        try:
            ...
            await str16.start()
            await str16(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str16(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if seventeen:
        ...
        try:
            ...
            await str17.start()
            await str17(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str17(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if eighteen:
        ...
        try:
            ...
            await str18.start()
            await str18(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str18(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if nineteen:
        ...
        try:
            ...
            await str19.start()
            await str19(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str19(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if twenty:
        ...
        try:
            ...
            await str20.start()
            await str20(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str20(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if twentyone:
        ...
        try:
            ...
            await str21(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str21(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            str21 = "twentyone"
...
##############            
    ...
    if twentytwo:
        ...
        try:
            ...
            await str22.start()
            await str22(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str22(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if twentythree:
        ...
        try:
            ...
            await  str23.start()
            await str23(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str23(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if twentyfour:
        ...
        try:
            ...
            await str24.start()
            await str24(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str24(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if twentyfive:
        ...
        try:
            ...
            await str25.start()
            await str25(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str25(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if twentysix:
        ...
        try:
            ...
            await str26.start()
            await str26(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str26(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if twentyseven:
        ...
        try:
            ...
            await str27.start()
            await str27(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str27(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if twentyeight:
        ...
        try:
            ...
            await str28.start()
            await str28(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str28(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if twentynine:
        ...
        try:
            ...
            await str29.start()
            await str29(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str29(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
...
##############            
    ...
    if thirty:
        ...
        try:
            ...
            await str30.start()
            await str30(functions.channels.JoinChannelRequest(channel="@RoodClan"))
            await str30(functions.channels.JoinChannelRequest(channel="@RoodSpam"))
